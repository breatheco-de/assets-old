...
return function($api){
    ...
    $tags = ['infographic','cartoon','funny','screenshot','background','picture','drawing','explanation','css-exercises','html-exercises','react-exercises','javascript-exercises','python-exercises','fake-video-preview'];
